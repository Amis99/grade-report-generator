...
const Tables = {
    ...
    CLASSES: process.env.CLASSES_TABLE,
    STUDENT_CLASSES: process.env.STUDENT_CLASSES_TABLE,
    ASSIGNMENTS: process.env.ASSIGNMENTS_TABLE,
    ASSIGNMENT_QUESTIONS: process.env.ASSIGNMENT_QUESTIONS_TABLE,
    ASSIGNMENT_SUBMISSIONS: process.env.ASSIGNMENT_SUBMISSIONS_TABLE
};
